...
public:
	...
	struct FCameraFilmbackSettings                Filmback;                                          // 0x082C(0x000C)(Edit, BlueprintVisible, Interp, NoDestructor, NativeAccessSpecifierPublic)
	struct FCameraLensSettings                    LensSettings;                                      // 0x0838(0x0018)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FCameraFocusSettings                   FocusSettings;                                     // 0x0850(0x0058)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)

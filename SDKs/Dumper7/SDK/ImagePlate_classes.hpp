...
public:
	...
	uint8                                         Pad_488[0x89];                                     // 0x0488(0x0089)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bUpdateOnlyIfRendered;                             // 0x0511(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_512[0xE];                                      // 0x0512(0x000E)(Fixing Struct Size After Last Property [ Dumper-7 ])

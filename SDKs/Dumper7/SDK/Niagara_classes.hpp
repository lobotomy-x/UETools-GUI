...
public:
	...
	uint8                                         Pad_59B[0x3D];                                     // 0x059B(0x003D)(Fixing Size After Last Property [ Dumper-7 ])
	class UNiagaraEffectType*                     RegisteredEffectType;                              // 0x05D8(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)

...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_Action_FatalAttack_Victim_BeforeHit_C; // 0x03B0(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	class FName                                   CommonAnim_FatalNPCHit_Before;                     // 0x03B8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("BP_Action_FatalAttack_Victim_BeforeHit_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_Action_FatalAttack_Victim_BeforeHit_C")
	}
